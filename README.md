...
<h1 align="center">Flutter Budget App UI (Completed)</h1>

<p align="center">This repository contains the sample code of a simple budget app which is used for demo in the Devera Flutter course</p>

<br/>

# Getting Started

This repository contains the sample code of the Budget App (only UI) which is used to demonstrate in [Devera](https://devera.vn) Flutter course how to build the UI in a Flutter application.

# How to use

## Step 1: 
Download or clone this repository.
> https://github.com/hungnm138/devera-flutter-budget-app-ui-completed 
